        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('removedby', models.IntegerField(
                    blank=True, db_column='RemovedBy', null=True)),
                ('removetype', models.CharField(blank=True,
                 db_column='RemoveType', max_length=3, null=True)),
                ('removedon', models.IntegerField(
                    blank=True, db_column='RemovedOn', null=True)),
